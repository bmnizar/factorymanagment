				  ...
				  <div class="modal-header">
					...
					<div class="modal-body">
						<form role="form">
								...
								<div class="form-group"> <!-- Name field -->
									<label class="control-label " for="name">Réference Produit</label>
									<input ng-model="ctrl.productConstruction.product.refProduct" class="form-control" id="ref" name="ref" type="text"/>
								</div>
	
								<div class="form-group"> <!-- Email field -->
									<label class="control-label " for="df">Durée de Fabrication (unité)<span class="asteriskField">*</span></label>
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Modification</h4>
          ...
          <div class="modal-body">
					...
					<div class="form-group">
						<label for="typeproduit">Réference de produit </label> 
        
						<input class="form-control " type="text" placeholder="z8zaz2">
					</div>
					<div class="form-group">
						<label for="quantiteproduit">Durée de fabrication</label> 
