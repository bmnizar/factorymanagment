'use strict';
ProductCalculationApp
.controller(
	'ProductCalculationCtrl',
	function ($scope, ProductService, $rootScope, UserService,$http,
	...
	self.calculateProductTime = function (productName) {
	var toBeSent=[];
	toBeSent[0]=self.selectedProduct;
	toBeSent[1]=self.quantityOfProducts;
	var toBeSentJson=JSON.stringify(toBeSent);
	$http
			.post('http://localhost:8083/factorymanagment/calculateProductTime/',toBeSentJson)
